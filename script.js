document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadConfig = () => {
        if (typeof CONFIG === 'undefined') {
            console.error('Configuration Missing: Please ensure config.js is present in the repository.');
            globalError.style.display = 'block';
            globalError.textContent = 'Configuration Error: Site is not properly configured. Please contact the administrator.';
            return false;
        }
